...
class CaseSummaryGenerator:
    ...
    def _generate_ai_executive_summary(self, case_summary: CaseSummary) -> ExecutiveSummaryResponse:
        ...
        # Executive summary prompt (following forensic analysis patterns)
...
Be conservative with confidence scores - use >0.9 only for extremely clear cases.
Maintain professional legal analysis tone suitable for court proceedings."""
