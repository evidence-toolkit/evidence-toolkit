...
from .ai_models import ImageAnalysisStructured
...
class ImageAnalyzer:
    ...
    def __init__(
        ...
        model: str = "gpt-4.1-mini",  # Cost-effective vision model with 1M+ context
        max_tokens: int = 1000,
        verbose: bool = True
    ):
        ...
        Args:
            ...
            model: Vision-capable model (default: gpt-4.1-mini - best balance of cost/quality)
